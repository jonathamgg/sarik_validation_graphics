...
caminho1=../../../../validacao/latencia/grupo1/dia_7
caminho2=../../../../validacao/latencia/grupo2/dia_7

# pasta experimento
comando=apt

# caminho dos pods 
db=metricas_para_R_pod_db-684b9b49fd-h86tp.csv
redis=metricas_para_R_pod_redis-67db9bd79b-z92fj.csv
result=metricas_para_R_pod_result-77f68799c4-ml9k2.csv
vote=metricas_para_R_pod_vote-79787c6c8b-sbggz.csv
work=metricas_para_R_pod_worker-78b9ff59fc-rvtgx.csv
