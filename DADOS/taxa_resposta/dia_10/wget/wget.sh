...
caminho1=../../../../validacao/taxa_resposta/grupo1/dia_10
caminho2=../../../../validacao/taxa_resposta/grupo2/dia_10

# pasta experimento
comando=wget

# caminho dos pods 
db=metricas_para_R_pod_db-684b9b49fd-75jjw.csv
redis=metricas_para_R_pod_redis-67db9bd79b-msprv.csv
result=metricas_para_R_pod_result-77f68799c4-tkqx9.csv
vote=metricas_para_R_pod_vote-79787c6c8b-hdd92.csv
work=metricas_para_R_pod_worker-78b9ff59fc-bnftj.csv
