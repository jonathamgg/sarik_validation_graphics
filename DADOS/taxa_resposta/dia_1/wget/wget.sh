...
caminho1=../../../../validacao/taxa_resposta/grupo1/dia_1
caminho2=../../../../validacao/taxa_resposta/grupo2/dia_1

# pasta experimento
comando=wget

# caminho dos pods 
db=metricas_para_R_pod_db-684b9b49fd-bw6q4.csv
redis=metricas_para_R_pod_redis-67db9bd79b-bhpps.csv
result=metricas_para_R_pod_result-77f68799c4-2g2gv.csv
vote=metricas_para_R_pod_vote-79787c6c8b-tk4cn.csv
work=metricas_para_R_pod_worker-78b9ff59fc-sc8xc.csv
