...
caminho1=../../../validacao/taxa_transmissao/grupo1/dia_8
caminho2=../../../validacao/taxa_transmissao/grupo2/dia_8

# caminho dos pods
db=metricas_para_R_pod_db-684b9b49fd-sc2c4.csv
redis=metricas_para_R_pod_redis-67db9bd79b-rftbr.csv
result=metricas_para_R_pod_result-77f68799c4-jtcfz.csv
vote=metricas_para_R_pod_vote-79787c6c8b-lwdmh.csv
work=metricas_para_R_pod_worker-78b9ff59fc-gmh7j.csv
