...
caminho1=../../../validacao/taxa_transmissao/grupo1/dia_6
caminho2=../../../validacao/taxa_transmissao/grupo2/dia_6

# caminho dos pods
db=metricas_para_R_pod_db-684b9b49fd-whqgb.csv
redis=metricas_para_R_pod_redis-67db9bd79b-cp5zn.csv
result=metricas_para_R_pod_result-77f68799c4-4gzjs.csv
vote=metricas_para_R_pod_vote-79787c6c8b-kw5cn.csv
work=metricas_para_R_pod_worker-78b9ff59fc-xxv5d.csv
