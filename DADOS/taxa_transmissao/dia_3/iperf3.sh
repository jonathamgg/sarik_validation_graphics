...
caminho1=../../../validacao/taxa_transmissao/grupo1/dia_3
caminho2=../../../validacao/taxa_transmissao/grupo2/dia_3

# caminho dos pods
db=metricas_para_R_pod_db-684b9b49fd-m6zb8.csv
redis=metricas_para_R_pod_redis-67db9bd79b-dxqz2.csv
result=metricas_para_R_pod_result-77f68799c4-6z8xk.csv
vote=metricas_para_R_pod_vote-79787c6c8b-5z79m.csv
work=metricas_para_R_pod_worker-78b9ff59fc-shzk5.csv
