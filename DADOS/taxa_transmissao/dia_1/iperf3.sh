...
caminho1=../../../validacao/taxa_transmissao/grupo1/dia_1
caminho2=../../../validacao/taxa_transmissao/grupo2/dia_1

# caminho dos pods
db=metricas_para_R_pod_db-684b9b49fd-xm5v9.csv
redis=metricas_para_R_pod_redis-67db9bd79b-qrpbx.csv
result=metricas_para_R_pod_result-77f68799c4-ccpd7.csv
vote=metricas_para_R_pod_vote-79787c6c8b-98grw.csv
work=metricas_para_R_pod_worker-78b9ff59fc-hffr7.csv
