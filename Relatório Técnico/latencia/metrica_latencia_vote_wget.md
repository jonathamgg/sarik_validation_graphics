...
[Link para o arquivo CSV](https://github.com/jonathamgg/sarik_validation_graphics/blob/master/c%C3%A1lculo%20estat%C3%ADstico%20com%20jamovi/latencia/vote/media_latencia_wget.csv)
...
Estatística t de Student: -1706 (gl = 16.0, p < .001)

t de Welch: -1706 (gl = 8.99, p < .001)

Teste de Levene para Homogeneidade de Variâncias: F = 8.10, gl1 = 1, gl2 = 16, p = 0.012
