...
[Link para o arquivo CSV](https://github.com/jonathamgg/sarik_validation_graphics/blob/master/c%C3%A1lculo%20estat%C3%ADstico%20com%20jamovi/latencia/redis/media_latencia_curl.csv)
...
Estatística t de Student: -340 (gl = 18.0, p < .001)

t de Welch: -340 (gl = 9.01, p < .001)

Teste de Levene para Homogeneidade de Variâncias: F = 20.0, gl1 = 1, gl2 = 18, p = 0.001
