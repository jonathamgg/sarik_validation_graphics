...
[Link para o arquivo CSV](https://github.com/jonathamgg/sarik_validation_graphics/blob/master/c%C3%A1lculo%20estat%C3%ADstico%20com%20jamovi/taxa_resposta/db/media_tr_wget.csv)
...
Estatística t de Student: -102 (gl = 13.0, p < .001)

t de Welch: -127 (gl = 8.03, p < .001)

Teste de Levene para Homogeneidade de Variâncias: F = 28.6, gl1 = 1, gl2 = 13, p = 0.001
