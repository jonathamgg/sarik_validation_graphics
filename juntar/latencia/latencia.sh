...
caminho1=../../latencia/grupo1
caminho2=../../latencia/grupo2
...
cat $caminho1/$comando/$db >> $db1.csv
...
cat $caminho1/$comando/$redis >> $redis1.csv
...
cat $caminho1/$comando/$result >> $result1.csv
...
cat $caminho1/$comando/$vote >> $vote1.csv
...
cat $caminho1/$comando/$work >> $work1.csv
